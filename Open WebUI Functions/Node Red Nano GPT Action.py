"""
title: Node Red Nano GPT Action (Images)
author: Elliott Groves
node red flow: https://github.com/Orciotrox/NodeRed-Nano-GPT.com-OpenWebUI
version: 0.1.0
"""
...
class Action:
    class Valves(BaseModel):
        OPENAI_API_BASE_URL: str = Field(
            default="http://192.168.1.69:1880",
            description="The base URL for OpenAI API and image generation",
        )
        OPENAI_API_KEY: str = Field(
            default="c8f4185a-ef95-40cd-bf2e-449d9c980b5b",
